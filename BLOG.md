...
A POST endpoint that accepts JSON-RPC style requests (e.g., {"jsonrpc": "2.0", "id": "...", "method": "cultural_insights", "data": {...}})
...
🛰️ Connecting to Telex (A2A Endpoint)
...
👉 GitHub Repo:
https://github.com/yourusername/telex-cultural-coworker
